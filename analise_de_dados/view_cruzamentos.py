...
# TESTE:
# df = dados('dados\dados_brutos.csv')
# times = obtem_times(df)

# resultados = {}

# for id_time in times:
#     for tempo_jogo in [1, 2]:
#         # Concatenar os resultados de ambos os tempos de jogo
#         resultados.update(cruzamentos(df, id_time, tempo_jogo, times))
...
resultados = cruzamentos(df, times[1], 1, times)
